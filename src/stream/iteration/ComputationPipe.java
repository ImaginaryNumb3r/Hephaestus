 ...
 * @author Patrick
 * @since 14.01.2018
 * An IterationSource is a readable node in the chain matchAllSink Iteration operations.
...
abstract class ComputationPipe<in, out> implements IterationSource<out> {
    ...
    public out next() {
        ...
        // matchAllSink the iterator has no meaning to this class. Therefore, we always process one more item than required.
